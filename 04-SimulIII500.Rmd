...
#----- Reading in data
pathy="C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Code/ComputerExperiments/Simulation III/"
TabyVal_mean=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/TabyVal_mean_n500Base_NoiseHomosk.csv"),row.names=1)
Tabypsi1_mean=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/Tabypsi1_mean_n500Base_NoiseHomosk.csv"),row.names=1)
Tabypsi2_mean=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/Tabypsi2_mean_n500Base_NoiseHomosk.csv"),row.names=1)

TabyVal_median=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/TabyVal_median_n500Base_NoiseHomosk.csv"),row.names=1)
Tabypsi1_median=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/Tabypsi1_median_n500Base_NoiseHomosk.csv"),row.names=1)
Tabypsi2_median=read.csv(file=paste0(pathy,"SimulationIII_TablesFigures/Tabypsi2_median_n500Base_NoiseHomosk.csv"),row.names=1)
