...
fig <- plot_ly(x = ~theta[,1], y = ~theta[,2], z = ~z, type="scatter3d", mode="markers")
fig
```
...
#----- Reading in data
pathy="C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Code/ComputerExperiments/Simulation II/"
TabyVal_mean=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/TabyVal_mean_n1000_Base_NoiseHeterosk.csv"),row.names=1)
Tabypsi1_mean=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/Tabypsi1_mean_n1000_Base_NoiseHeterosk.csv"),row.names=1)
Tabypsi2_mean=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/Tabypsi2_mean_n1000_Base_NoiseHeterosk.csv"),row.names=1)

TabyVal_median=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/TabyVal_median_n1000_Base_NoiseHeterosk.csv"),row.names=1)
Tabypsi1_median=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/Tabypsi1_median_n1000_Base_NoiseHeterosk.csv"),row.names=1)
Tabypsi2_median=read.csv(file=paste0(pathy,"SimulationII_TablesFigures/Tabypsi2_median_n1000_Base_NoiseHeterosk.csv"),row.names=1)
...
Valmat=read.csv(file="C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Code/ComputerExperiments/Simulation II/SimulationII_TablesFigures/Valmat_n1000Base_NoiseHeterosk.csv")
...
jpeg("C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Manuscript/SimulationII_Figures/boxplotpsi1_n1000_covtype3_heterosknoise.jpg", width = 1000, height = 500)
p1
dev.off()
...
p2=ggplot(Valmat, aes(y=psi2, x=Samp_numb, group=interaction(type_simul,Samp_numb), col=as.factor(type_simul))) +  
  ...
  theme(text = element_text(size = 20))+
  labs(x ="Number of Additional Points", y = "Optimal Threshold")
jpeg("C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Manuscript/SimulationII_Figures/boxplotpsi2_n1000_covtype3_heterosknoise.jpg", width = 1000, height = 500)
p2
dev.off()
...
jpeg("C:/Users/Administrator/Dropbox/Daniel_PhD_Research/Objective II/Manuscript/SimulationII_Figures/boxplotvalue_n1000_covtype3_heterosknoise.jpg", width = 1000, height = 500)
p3
dev.off()
```
